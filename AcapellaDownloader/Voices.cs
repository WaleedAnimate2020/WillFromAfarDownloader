       ...
       static Voices()
        {
			...
			new Voice("Rikke", Gender.Female, "da_dk", "dad_rikke_22k_ns.bvcu"),
			...
			new Voice("Darian", Gender.Female, "en_us", "enu_darian_22k_ns.bvcu"),
			...
			new Voice("Melanie", Gender.Female, "fr_ca", "frc_melanie_22k_ns.bvcu"),
			...
			new Voice("Thijs", Gender.Male, "nl_nl", "dun_thijs_22k_ns.bvcu"),
			new Voice("Merel", Gender.Female, "nl_nl", "dun_merel_22k_ns.bvcu"),
